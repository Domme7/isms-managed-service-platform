    ...
    <section className="pb-hinweis" aria-label="Seitenbausteine dieser Seite">
      <details className="pb-details">
        <summary className="pb-summary">
          Seitenaufbau: Von den neun verbindlichen Seitenbausteinen trägt der Datenbestand auf
          dieser Seite{' '}
          {ohneTraeger.length === 0 ? 'alle mindestens teilweise' : `${ohneTraeger.length} nicht`}
