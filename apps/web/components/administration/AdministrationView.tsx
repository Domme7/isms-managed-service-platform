...
export function AdministrationView() {
  ...
  // Cockpit-Themenwahl). Kopf, Leitfrage und Inhalt bleiben unverändert in `AdministrationContent`.
  return (
    <BereichRahmen>
      {!hydrated ? (
        <>
        ...
        <>
          ...
          <div className="tw-empty" role="note">
            ...
            <p style={{ marginTop: 0 }}>
              Es ist kein Mandant gewählt. Melden Sie sich an, um den Konfigurationsstand des
        ...
        <AdministrationContent role={resolved.role} tenant={resolved.tenant} />
      )}
    </BereichRahmen>
  );
}
