...
| O-GH-001 | Unter welchem privaten GitHub-Konto oder welcher Organisation liegt das Repository? | teilweise | Human Product Owner |
...
| O-DEV-001 | Lokale Containerumgebung oder Dev Container? | nein | CTO ADR |
