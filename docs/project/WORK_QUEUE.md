...
| P0 | WP-002 | Technologie-ADR und ausführbares App-Grundgerüst | 0–1 | **Draft bereit / Human Gate offen** | WP-001 ✓, Capability Check ✓ | Stack-/Kostenentscheidung bei materialer Bindung |
...
WP-001 ist als Phase-0-Baseline abgeschlossen. Nächstes Paket ist der **WP-002-Entwurf**
(`work-packages/WP-002_TECH_ADR_UND_APP_GRUNDGERUEST.md`); dessen Start benötigt ein Human Gate
zur Stack-Bindung (Stack wird nicht still festgelegt). Die Reihenfolge der späteren Pakete darf
durch den Orchestrator verfeinert werden, ohne die Produktvision zu verkleinern.
