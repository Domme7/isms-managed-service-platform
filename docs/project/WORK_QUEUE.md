...
| P1 | WP-003 | Kanonische Datenverträge (`@isms/contracts`) & synthetische Demo-Seed | 1 | **Active (Slice 1 done, Slice 2 offen)** | WP-002 ✓, Dok. 07 | keine DB/ORM/Docker, keine realen Daten |
