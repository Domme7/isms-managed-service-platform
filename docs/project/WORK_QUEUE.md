...
| P2 | WP-025 | Design-Exploration Cockpit (IDEA-001): 2–3 statische Stilvarianten, Owner wählt (DR-0003: kleinste Variante zeigen) | quer | **Kern in WP-020-Sprint gezogen (DR-0010): Cockpit-Varianten + Varianten-Stopp** | WP-020-Struktur, `qa:visual` | Owner wählt die Variante |
| P2 | WP-023 | Konzeptfassungen Teil 2: die 14 material abweichenden Dokumente (00, 08–18, 20B, 20C) | quer | **Done (2026-07-23: 13× Gate-FREIGABE Runde 1, Dok. 10 inhaltlich bestanden; Archivkopien + Manifest nachgezogen; Nachtrag in `docs/concept/abgleich/`)** | WP-019-Muster, Abgleichbericht | keiner |
...
| P1 | WP-028 | **Produktsprache ohne Demo-Disclaimer (DR-0011):** „synthetisch/Demo/Simulation"-Hinweise aus allen nutzersichtbaren Texten entfernen; Datenehrlichkeit + Mandantengrenze bleiben; neuer Wächter gegen Wiederkehr | quer | **Next (nach Kundenwelt-Slice, DR-0011)** | WP-020 ✓ | Product + Konzepttreue + QA |
| P1 | WP-029 | **Kuratierte Cockpit-Personalisierung (DR-0012 B(a)):** Kacheln umsortieren/anheften, gespeicherte Sichten/Filter, Management-Modus-Umschalter (Dok. 10 §6.3) — **kein freier Layout-Builder** (06-O09 offen); sicherheitskritische Signale nie wegkonfigurierbar (Dok. 06 §6.2) | 1/4 | Planned (nach Varianten-Stopp) | WP-020 ✓, Dok. 06 §6.2/§15, Dok. 10 §5.5/§6.3 | Product |
| P1 | WP-030 | **Getrennte Anmeldewelten Berater/Kunde, eine Plattform (DR-0012 A(a)):** getrennte Login-Einstiege + Identitätstypen/Sphären/Föderation, Kontextwechsel (Dok. 19 §7/8/10/11); löst DR-0009 O-KUNDE-02 ein | 2/9 | Planned | **FINDING-0004 (RLS)**, Dok. 19, WP-006 | **Security Review Pflicht; echte Auth** |
| P2 | WP-031 | Freier Cockpit-Layout-Builder (DR-0012 B(b), zurückgestellt) — **erst nach Konzeptentscheidung 06-O09** (Change Proposal) | 4 | Blocked (06-O09) | WP-029, Concept Author | Human Gate (06-O09) |
