...
| P1 | WP-013 | ISMS-Kern-Welt (read-only): Ort „ISMS" mit Risiken/Controls/Maßnahmen/Evidence | 1/3 | **Slice 1 gebaut + QA ✓ — Reviews laufen** | WP-012 ✓, Dok. 08/06 | keiner (read-only, synthetisch) |
