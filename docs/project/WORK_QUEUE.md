...
| P1 | WP-020 | **Verdichtungs-Umbau + erste Dashboard-Schicht** (DR-0008): strategisch → Drill-down (Detailtiefe §6.2, Rollenvarianten, Seitenbausteine §6.1) **plus Statuskacheln/Ampel-Badges/Abdeckungsbalken aus heutigen Daten, je mit Drill-down**; Cross-Tenant-Schutz als Sicherheits-Slice vorweg; Punkt 8 (`weight`) nur als Change Proposal | 1/2 | **Next** | WP-019 ✓, Nachtrag, DR-0008 | Security-Slice: Security Review; Owner-Abnahme je Stufe via qa:visual |
