...
| P1 | WP-020 | **Verdichtungs-Umbau nach Dok. 06** (Owner-bekräftigt: strategisch → Drill-down): Detailtiefe-Ebenen §6.2 + Mission-Control-Rollenvarianten + Seitenbausteine §6.1, Cross-Tenant-Schutz als Sicherheits-Slice vorweg; übrige Punkte der 11er-Liste im WP-019-Nachtrag; Punkt 8 (`weight` im Contract) nur als Change Proposal | 1/2 | **Next** | WP-019 ✓, Nachtrag, IDEA-001-Nachtrag | Security-Slice: Security Review; Punkt 8 Human Gate |
